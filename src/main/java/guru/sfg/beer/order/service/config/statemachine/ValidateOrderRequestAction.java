...
import courses.microservices.brewery.model.ValidateBeerOrderRequest;
...
public class ValidateOrderRequestAction implements Action<OrderStatusEnum, BeerOrderEvent> {
  ...
  public void execute(StateContext<OrderStatusEnum, BeerOrderEvent> context) {
    ...
    jmsTemplate.convertAndSend(JmsConfig.VALIDATE_ORDER_QUEUE, new ValidateBeerOrderRequest(beerOrderMapper.beerOrderToDto(order)));
  }
